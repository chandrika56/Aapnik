...
public class sortVote extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView (R.layout.activity_sort_vote);
...
//                Toast.makeText(MainActivity.this, "Spinner item selected", Toast.LENGTH_LONG).show();
                ...
                stackOverflowAPI.getAnswersForQuestion3().enqueue(answersCallback);
            }
       ...
       /* List<Question> questions = FakeDataProvider.getQuestions();
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager (sortVote.this));
    ...
    Callback<ListWrapper<Question>> questionsCallback = new Callback<ListWrapper<Question>>() {
        ...
        public void onResponse(Call<ListWrapper<Question>> call, Response<ListWrapper<Question>> response) {
            if (response.isSuccessful()) {
                ...
                ArrayAdapter<Question> arrayAdapter = new ArrayAdapter<Question>(sortVote.this, android.R.layout.simple_spinner_dropdown_item, questions.items);
                questionsSpinner.setAdapter(arrayAdapter);
            } else {
